...
| 🪟 [WPF UI Engineer](engineering/engineering-wpf-ui-engineer.md) | XAML, MVVM, custom controls, data binding, WPF desktop apps | Windows desktop UI development, enterprise LOB apps, data visualization |
